...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".del_btn").button().click(function () {
                ...
                window.location = 'deleteOpenstackVM.action?hostSystem.id=' + id + '&sortedSet.orderByDirection=<s:property value="sortedSet.orderByDirection" />&sortedSet.orderByField=<s:property value="sortedSet.orderByField"/>';
            });
    ...
    <title>KeyBox - Manage OpenStack VM</title>
</head>
<body>
...
<div class="container">
    ...
    <h3>Manage OpenStack VMs</h3>

    <p>Add / Delete VMs below or distribute SSH keys</p>
    ...
    <button class="btn btn-default add_btn spacer spacer-bottom" data-toggle="modal" data-target="#add_dialog">Add OpenStack VM</button>
                ...
                <div class="modal-body">
                    <div class="row">
                        <s:form action="saveOpenStackVM">
                            ...
                            <s:select name="openStackVM.network" label="Network" list="networkMap"/>
                            <s:select name="openStackVM.securityGroup" label="Security Group" list="securityList"/>
                            <s:textfield name="hostSystem.user" label="Image User" size="10"/>
                        </s:form>
                    </div>
                </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <s:form action="saveSystem" id="save_sys_form_edit_%{id}">
                                ...
                                <s:textfield name="hostSystem.authorizedKeys" value="%{authorizedKeys}" label="Authorized Keys" size="30"/>
